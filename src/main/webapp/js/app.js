...
angular.module('myApp', ['myApp.filters','episodeService','ngResource','ui.bootstrap','ngGrid','ngRoute','myApp.directives','ui.bootstrap.datetimepicker','angularFileUpload']).
